        ...
        <div class="contactBody-div"> 
            ...
            <div class="usersAndOurInfo-div">
                ...
                <p>Send us a message and we'll respond within 24 hours</p>
                    ...
                    <p>Full Name:</p>
                    <input id="fullName" type="text" name="fullName" size="15" maxlength="20"/> 
                    ...
                    <p>Organization:</p>
                    <input id="organization" type="text" name="organization" size="15" maxlength="20"/>
                    </div>
                    </div>

                    <div class="comment-div">
                    <textarea id="message"name="message" placeholder="Your Message" cols="54" rows="10"></textarea>
